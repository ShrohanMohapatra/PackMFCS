...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun 17 14:16:54 2021
...
xElements, yElements = [], []
for numberOfElements in range(1,801,20):
    ...
    for k in range(1,numberOfElements+1):
        ...
        sumTime += (end-start)*10**6
    xElements.append(numberOfElements)
    yElements.append(sumTime/numberOfElements)
pyplot.plot(xElements,yElements)